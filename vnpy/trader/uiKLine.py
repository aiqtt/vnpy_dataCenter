...
class KLineWidget(KeyWraper):
    ...
    def plotOI(self,xmin=0,xmax=-1):
        ...
        if self.initCompleted:
            ...
            self.curveOI.setData(self.listOpenInterest[xmin:xmax] + [0], name="OpenInterest")#去除symbol='o'
    ...
    def addIndicatorSar(self, sarDatas):
        ...
        for i in range(len(sarDatas)):
            ...
            arrow = pg.ArrowItem(pos=(i, sarDatas[i]), angle=90,tipAngle=5, headLen=2,tailWidth=4,pen={'width':1}, brush=(0, 0, 255))
        ...
        for i in range(len(self.listSig)):
            ...
            # 买信号
                ...
                if direction == "空" and offset == "开仓":
                    ...
                    arrow = pg.ArrowItem(pos=(i, price), angle=180, tipAngle=60, headLen=8, tailLen=3, tailWidth=5, pen={'color': 'w', 'width': 1},brush='r' )
