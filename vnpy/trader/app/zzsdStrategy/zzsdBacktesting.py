...
class BacktestingEngine(object):
    ...
    def __init__(self):
        ...
        self.accountManager = AccountManager(self.positionManager)
    ...
    def runBacktesting(self):
        ...
        while True:
            ...
            if not self.strategy.has_key(self.mainSymbol):
                ...
                self.strategy[self.mainSymbol].initDayBar(self.loadDayData(self.mainSymbol,curDate ))
                self.strategy[self.mainSymbol].initHourBar(self.loadHourData(self.mainSymbol,curDate ))
            ...
            if self.mainSymbol != '' and self.strategy.has_key(self.mainSymbol) :
                mainBar = self.loadDayBar(self.mainSymbol,curDate)
                if mainBar:
