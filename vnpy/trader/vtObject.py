...
class VtPortfolioData(object):
    """组合资产包类"""

    # ----------------------------------------------------------------------
    def __init__(self):
        """Constructor"""
        super(VtPortfolioData, self).__init__()
        self.symbol=EMPTY_STRING #组合资产包name
        self.vtSymbol = EMPTY_STRING  # vt系统代码
        ...
        self.lastPrice = EMPTY_FLOAT  # 组合资产包最新价格
        self.volume = EMPTY_INT  # 成交量
        self.openInterest = EMPTY_INT  # 持仓量
        self.upperLimit=EMPTY_FLOAT#组合资产包上区间
        self.lowerLimit=EMPTY_FLOAT#组合资产包下区间

class VtPortfolioBarData(VtBaseData):
        """组合资产包类"""

        # ----------------------------------------------------------------------
        def __init__(self):
            """Constructor"""
            super(VtPortfolioBarData, self).__init__()
            # self.portfolioName = EMPTY_STRING  # 组合资产包name
            self.symbol = EMPTY_STRING  # 组合资产包name
            self.vtSymbol = EMPTY_STRING  # vt系统代码
            self.exchange = EMPTY_STRING        # 交易所
            self.gatewayName = EMPTY_STRING
