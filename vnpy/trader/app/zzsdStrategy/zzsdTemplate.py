...
from .zzsdBase import *
from math import ceil, floor

########################################################################
class ZzsdTemplate(object):
    """ZZSD策略模板"""
    ...
    #----------------------------------------------------------------------
    def buy(self, price, volume,stopPrice, stop=False):
        """买开"""
        ##计算volume
    ...
    #----------------------------------------------------------------------
    def short(self, price, volume,stopPrice, stop=False):
        """卖开"""
...
########################################################################
class TargetPosTemplate(ZzsdTemplate):
    """
